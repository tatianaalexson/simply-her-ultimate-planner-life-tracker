...
export const FEATURES = [
  ...
  // Kitchen
  { id: 'kit.mealplan', group: 'kitchen', label: 'Meal Planning', vis: v(true) },
  { id: 'kit.recipes', group: 'kitchen', label: 'Recipes' },
  { id: 'kit.grocery', group: 'kitchen', label: 'Grocery Lists', vis: v(false, false, true) },
  ...
  { id: 'kit.mealprep', group: 'kitchen', label: 'Meal Prep' },
